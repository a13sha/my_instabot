...
from .test_variables import (TEST_CAPTION_ITEM, TEST_COMMENT_ITEM, TEST_PHOTO_ITEM,
...
class TestBotFilter(TestBot):
    ...
    @responses.activate
    @pytest.mark.parametrize('media_id,total,max_per_day', [
        [111111, 1, 2],
        [111111, 2, 2],
        [111111, 3, 2],
        ['111111', 1, 2],
    ...
    def test_unlike_comment(self, patched_time_sleep, comment_id):
        responses.add(
            responses.POST, "{api_url}media/{comment_id}/comment_unlike/".format(
    ...
    @responses.activate
    @pytest.mark.parametrize('media_ids,total,max_per_day', [
        [[111111, 222222], 1, 3],
        [[111111, 222222], 2, 3],
        [[111111, 222222], 3, 3],
        [['111111', '222222'], 1, 3],
    ...
    def test_unlike_medias(self, patched_time_sleep, media_ids, total, max_per_day):
        ...
        test_unlike_meds = self.bot.unlike_medias(media_ids)
    ...
    def test_unlike_user(self, patched_time_sleep):
        ...
        test_unlike_usr = self.bot.unlike_user(user_id)
